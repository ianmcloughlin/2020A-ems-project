...
\begin{document}
  ...
  \section*{Instructions}
    ...
    The goal is to produce a model that accurately predicts \texttt{power} values from \texttt{speed} values, as in the data set.
    ...
    \begin{enumerate}
      ...
      \item Dockerfile to run the web service in a container.
